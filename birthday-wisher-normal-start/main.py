# To run this continually, can use a service like https://pythonanywhere.com.
...
def send_birthday_email(name, recipient):
    """
    send an email with the subject and body to the specified recipient
    :param name: name of the person to send the email to
    :param recipient: email address the email will be sent to
    """
    file_index = Random().randint(1,3)
    file_path = f"letter_templates/letter_{file_index}.txt"

    with open(file_path, "r") as file_data:
        letter = file_data.read()
